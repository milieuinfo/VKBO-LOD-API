...
/** Controller serving HTML views for organisation data from the VKBO source. */
@Controller
public class HTMLController {
  ...
  public String getOndernemingDoc(@PathVariable String ondernemingsnr, Model model) {
    ...
    try {
      ...
      for (int i = 0; i < featureCount; i++) {
        ...
        location.put("name", props.has("Maatschappelijke_naam")
            ? props.get("Maatschappelijke_naam").asText()
            : "Onbekend");
