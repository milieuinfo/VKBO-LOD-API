...
public class BlankNodeHandlingTest {
  ...
  public void testBlankNodeHandling() {
    ...
    assertEquals("http://www.w3.org/ns/org#Organization", namedResource.getValue(),
        "Named resource should have correct URI");
    ...
    boolean namedResourceUsesLink =
        !namedResource.isLiteral && namedResource.value != null && !namedResource.value.isEmpty();
    boolean blankNodeUsesSpan =
        !blankNode.isLiteral && (blankNode.value == null || blankNode.value.isEmpty());
